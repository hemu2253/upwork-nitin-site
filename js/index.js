  ...
  var ie = (function (e) {
        ...
        return n !== E && 9 === n.nodeType && n.documentElement
          ? ((E = n),
            ...
            (x.find.CLASS =
              b.getElementsByClassName &&
              function (e, t) {
                if (typeof t.getElementsByClassName !== B && j)
    ...
    (t.matchesSelector = function (e, n) {
      if (
        ...
        (n = n.replace(fe, "='$1']")),
        b.matchesSelector && j && (!P || !P.test(n)) && (!H || !H.test(n)))
      )
        try {
          var r = L.call(e, n);
          if (
    ...
    return (
      ...
      (M = t.select =
        function (e, t, n, r) {
          ...
          return (
            (l || T(e, f))(r, t, !j, n, (we.test(e) && c(t.parentNode)) || t), n
          );
        }),
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (a = g.handle) ||
              (a = g.handle =
                function (t) {
                  return typeof K !== Te && K.event.triggered !== t.type
    ...
    K.fn.extend({
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          d = e[0],
          m = K.isFunction(d);
        if (m || (l > 1 && "string" == typeof d && !X.checkClone && He.test(d)))
      ...
      K.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return S(
            e,
            n,
            r ? D(e, t, r, "border-box" === K.css(e, "boxSizing", !1, i), i) : 0
          );
        },
      };
    }),
  ...
  (function (e, t) {
        ...
        n &&
          ...
          ((t =
            n[Ri] < 0 || n[Ri] > 11
              ...
              ? qi
              : -1),
          h(e)._overflowDayOfYear && (t < Li || t > Fi) && (t = Fi),
    ...
    function gt(e) {
      ...
      null != (t = e._w).GG || null != t.W || null != t.E
        ? ((o = 1),
          (a = 4),
          (n = ht(t.GG, e._a[Li], _e(Dt(), 1, 4).year)),
          (r = ht(t.W, 1)),
          ((i = ht(t.E, 1)) < 1 || i > 7) && (u = !0))
        : ((o = e._locale._week.dow),
          (a = e._locale._week.doy),
          (l = _e(Dt(), o, a)),
          (n = ht(t.gg, e._a[Li], l.year)),
          (r = ht(t.w, l.week)),
          null != t.d
            ? ((i = t.d) < 0 || i > 6) && (u = !0)
            : null != t.e
      ...
      if (t._f !== e.ISO_8601)
        if (t._f !== e.RFC_2822) {
          ...
          (h(t).charsLeftOver = c - f),
            ...
            null !== (s = h(t).era) &&
              (t._a[Li] = t._locale.erasConvertYear(s, t._a[Li])),
            mt(t),
            it(t);
        } else ft(t);
      else ot(t);
    ...
    function Rt(t, n) {
      ...
      return n._isUTC
        ? ((r = n.clone()),
          (i = (v(t) || u(t) ? t.valueOf() : Dt(t).valueOf()) - r.valueOf()),
      ...
      return (
        ...
        (t = xt(t))._a
          ? ((e = t._isUTC ? f(t._a) : Dt(t._a)),
            (this._isDSTShifted = this.isValid() && Ht(t._a, e.toArray()) > 0))
    ...
    function Yn(e, t, n) {
      return e < 100 && e >= 0
        ? new Date(e + 400, t, n) - jo
        : new Date(e, t, n).valueOf();
    }
    function En(e, t, n) {
      return e < 100 && e >= 0
        ? Date.UTC(e + 400, t, n) - jo
        : Date.UTC(e, t, n);
    }
    function An(t) {
      var n, r;
      ...
      switch (((r = this._isUTC ? En : Yn), t)) {
        ...
        case "hour":
          (n = this._d.valueOf()),
            (n -= On(n + (this._isUTC ? 0 : this.utcOffset() * Eo), Ao));
          break;
        case "minute":
    ...
    function jn(t) {
      ...
      switch (((r = this._isUTC ? En : Yn), t)) {
        ...
        case "hour":
          (n = this._d.valueOf()),
            (n +=
              Ao - On(n + (this._isUTC ? 0 : this.utcOffset() * Eo), Ao) - 1);
          break;
        case "minute":
    ...
    function Fr(e) {
      ...
      if ("month" === (e = R(e)) || "quarter" === e || "year" === e)
        switch (((t = this._days + r / 864e5), (n = this._months + Lr(t)), e)) {
          case "month":
            return n;
          case "quarter":
            return n / 3;
      ...
      B(["yo"], function (e, t, n) {
        ...
        n._locale._eraYearOrdinalRegex &&
          ...
          n._locale.eraYearOrdinalParse
            ? (t[Li] = n._locale.eraYearOrdinalParse(e, r))
            : (t[Li] = parseInt(e, 10));
      }),
      C(0, ["gg", 2], 0, function () {
    ...
    (Wo.add = Co),
      ...
      (Wo.zoneAbbr = vr),
      (Wo.zoneName = wr),
      (Wo.dates = _("dates accessor is deprecated. Use date instead.", Ho)),
  ...
  (Market.Helpers.GoogleAnalytics = {
    sendViewItemListEvent(e) {
      ...
      t.forEach((e) => {
        ...
        n.length > 0 &&
          (Market.Helpers.GoogleAnalytics.addImpressions(n),
          Market.Helpers.GoogleAnalytics.sendEvent(
            "event",
            "Ecommerce",
            "view",
            { label: "Product impression", nonInteraction: !0 }
          ));
    },
    sendPurchaseEvent(e) {
      if (!Market.Helpers.GoogleAnalytics.isEventStale(e.timestamp)) {
        const t = e.actionData.dimension7;
        delete e.actionData.dimension7,
          Market.Helpers.GoogleAnalytics.set("dimension7", `${t}`);
        const n = e.actionData.dimension15;
        return (
          delete e.actionData.dimension15,
          Market.Helpers.GoogleAnalytics.set("dimension15", `${n}`),
          Market.Helpers.GoogleAnalytics.set("dimension17", `${e.timestamp}`),
          Market.Helpers.GoogleAnalytics.addProducts(e),
          Market.Helpers.GoogleAnalytics.setAction("purchase", e.actionData),
          Market.Helpers.GoogleAnalytics.sendEvent(
            "event",
            "Ecommerce",
            "click",
